...
switch Action
    case 'init'
       ...
       % AxesHandles.HandleVevaiometric.YLim = [0 3]; %should be dependant
       % on data
    ...
    case 'update'
       ...
       % set(BpodSystem.GUIHandles.OutcomePlot.Aud,'xdata',find(BpodSystem.Data.Custom.AuditoryTrial),'ydata',BpodSystem.Data.Custom.DV(BpodSystem.Data.Custom.AuditoryTrial));
        ...
        if TaskParameters.GUI.ShowVevaiometric
            ...
            ndxCorrect =  BpodSystem.Data.Custom.ChoiceCorrect(1:iTrial) == 1; %only correct catch trials
            ...
            WTerr = grpstats(BpodSystem.Data.Custom.WaitingTime(ndxError),BinIdx(ndxError),'mean')';
            WTcorr = grpstats(BpodSystem.Data.Custom.WaitingTime(ndxCorrect),BinIdx(ndxCorrect),'mean')';
            Xerr = unique(BinIdx(ndxError))/DVNBin*2-1-1/DVNBin;
            Xcorr = unique(BinIdx(ndxCorrect))/DVNBin*2-1-1/DVNBin;
            ...
            BpodSystem.GUIHandles.OutcomePlot.VevaiometricCatch.YData = WTcorr;
            BpodSystem.GUIHandles.OutcomePlot.VevaiometricCatch.XData = Xcorr;
            if TaskParameters.GUI.VevaiometricShowPoints
                BpodSystem.GUIHandles.OutcomePlot.VevaiometricPointsErr.YData = BpodSystem.Data.Custom.FeedbackTime(ndxError);
                BpodSystem.GUIHandles.OutcomePlot.VevaiometricPointsErr.XData = DV(ndxError);
                BpodSystem.GUIHandles.OutcomePlot.VevaiometricPointsCatch.YData = BpodSystem.Data.Custom.FeedbackTime(ndxCorrect);
                BpodSystem.GUIHandles.OutcomePlot.VevaiometricPointsCatch.XData = DV(ndxCorrect);
            else
        ...
        if TaskParameters.GUI.ShowFeedback
            ...
            ndxError = BpodSystem.Data.Custom.ChoiceCorrect(1:iTrial) == 0 ; %all error trials
            ndxCorrect =  BpodSystem.Data.Custom.ChoiceCorrect(1:iTrial) == 1; %only correct


            BpodSystem.GUIHandles.OutcomePlot.HistErr = histogram(AxesHandles.HandleFeedback,BpodSystem.Data.Custom.FeedbackCheckpoint(ndxError));
            BpodSystem.GUIHandles.OutcomePlot.HistErr.BinWidth = .5;
            BpodSystem.GUIHandles.OutcomePlot.HistErr.EdgeColor = 'none';
            BpodSystem.GUIHandles.OutcomePlot.HistErr.FaceColor = 'r';
            %BpodSystem.GUIHandles.OutcomePlot.HistNoFeed.Normalization = 'probability';
            BpodSystem.GUIHandles.OutcomePlot.HistCorr = histogram(AxesHandles.HandleFeedback,BpodSystem.Data.Custom.FeedbackCheckpoint(ndxCorrect));
            BpodSystem.GUIHandles.OutcomePlot.HistCorr.BinWidth = .5;
            BpodSystem.GUIHandles.OutcomePlot.HistCorr.EdgeColor = 'none';
            BpodSystem.GUIHandles.OutcomePlot.HistCorr.FaceColor = 'b';
